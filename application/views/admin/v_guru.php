...
<head>
  ...
  <title>M-Sekolah | Data Dosen</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-star-o"></i> Prestasi Mahaiswa</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Tambah Dosen</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
