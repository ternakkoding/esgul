...
<head>
  ...
  <link rel="shorcut icon" type="text/css" href="<?php echo base_url().'assets/images/esgul.png'?>">
  <!-- Bootstrap 3.3.6 -->
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="ternakkoding.blogspot.com">Alifia DzuLL Azis | ternakkoding</a>.</strong> All rights reserved.
  </footer>
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Alif || TernakKoding </h4>

                <p>akan menjadi 21 Tahun pada 5 Agustus 2021</p>
              </div>
            </a>
          </li>
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Author mengubah profile nya </h4>

                <p>New phone +(62)895-6005-2473-5</p>
              </div>
            </a>
          </li>
          <li>
