          ...
          <div class="row">
              <div class="col-xs-6 col-sm-8 col-md-9">
                  <div class="header-top_address">
                      ...
                      <div class="header-top_list">
                          <span class="icon-envelope-open"></span>alif.esaunggul@gmail.com_create_guid
                      </div>
                      <div class="header-top_list">
                          <span class="icon-location-pin"></span>Kebon Jeruk, Jakarta Barat, INA. 172141
                      </div>
                  </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="foot-logo">
                    ...
                    <p><?php echo date('Y');?> © copyright by <br><a href="ternakkoding.blogspot.com" target="_blank">Alifia Dzull Azis | ternakkoding</a>. <br>All rights reserved.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
                ...
                <div class="col-md-3">
                  <div class="sitemap">
                      ...
                      <ul>
                          ...
                          <li><a href="<?php echo site_url('siswa');?>">Mmahasiswa </a></li>
