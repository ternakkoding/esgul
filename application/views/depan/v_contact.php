                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 contact-option">
                            <div class="contact-option_rsp">
                                ...
                                <form action="<?php echo site_url('contact/kirim_pesan');?>" method="post">
                                    ...
                                    <!-- // end .form-group -->
                                    <div class="form-group">
                                        <textarea placeholder="pesan" class="form-control" name="message" required rows="5"></textarea>
                                    </div>
                                    <!-- // end .form-group -->
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="contact-address">
                                ...
                                <div class="contact-details">
                                    ...
                                    <h6>Alamat</h6>
                                    <p> Universitas Esa Unggul
                                        <br> Jl. Arjuna Utara No.9, RT.1/RW.2, Duri Kepa, Kec. Kb. Jeruk, Kota Jakarta Barat
                                        <br> Daerah Khusus Ibukota Jakarta. 11510</p>
                                    </div>
                                    <br>
                                    <div class="contact-details">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="foot-logo">
                        ...
                        <p><?php echo date('Y');?> © copyright by <br><a href="http://ternakkoding.blogspot.com" target="_blank">Alifia Dzull Azis | ternakkoding</a>. <br>All rights reserved.</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="sitemap">
