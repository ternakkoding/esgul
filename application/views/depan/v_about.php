    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                ...
                <p>	Kami percaya bahwa Universitas Esa Unggul (UEU) akan mempunyai menjadi perguruan tinggi kelas dunia dan mempunyai reputasi tinggi bila mampu berkontribusi pada masyarakat melalui proses pendiseminasian ilmu pengetahuan (pendidikan), penemuan pengetahuan baru (penelitian) dan pengaplikasian ilmu pengetahuan untuk kesejahteraan umat manusia yang unggul (pengabdian pada masyarakat), yang unggul. Unggul berarti yang terbaik dan yang terdepan.
                </p>
                </div>
                <div class="col-md-5">
                ...
                <div class="col-md-12">
                    <div class="single-item">
                        <div class="quote">
                            ...
                            <p class="quote_text">Universitas Esa Unggul benar-benar mengagumkan. Saya sangat senang bisa bergabung dengan Esa Unggul dan menjadi mahasiswa terbaik tahun 2018.</p>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url().'theme/images/student1.png'?>" class="img-fluid" alt="#">
                                <p><span>Alifia Dzull Azis</span>Mahasiswa Terbaik 2022</p>
                            </div>
                        </div>
                        <div class="quote">
                            <i class="fa fa-quote-left" aria-hidden="true"></i>
                            <p class="quote_text">Esa Unggul benar-benar mengagumkan. Saya sangat senang bisa bergabung dengan Esa Unggul dan bisa mendapatkan pekerjaan yang saya inginkan sejak dulu. </p>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url().'theme/images/student2.png'?>" class="img-fluid" alt="#">
                                <p><span>Alif Dzull Azis</span>Mahasiswa Terbaik 2020</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="foot-logo">
                            ...
                            <p><?php echo date('Y');?> © copyright by <a href="http://ternakkoding.blogspot.com" target="_blank">Alifia Dzull Azis | ternakkoding</a>. <br>All rights reserved.</p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="sitemap">
