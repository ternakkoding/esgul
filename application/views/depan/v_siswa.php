    ...
    <div class="row">
        <div class="col-md-3">
            <div class="foot-logo">
                ...
                <p><?php echo date('Y');?> © copyright by <a href="http://ternakkoding.blogspot.com" target="_blank">M Fikri</a>. <br>All rights reserved.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="sitemap">
            ...
            <div class="col-md-3">
                <div class="address">
                    <h3>Hubungi Kami</h3>
                    <p><span>Alamat: </span> Kebon Jeruk, Jakarta Barat, INA. 172141</p>
